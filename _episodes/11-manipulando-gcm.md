...
- "¿Cómo estimamos las tasas de cambio para los periodos de interés?"
objectives:
- "Describir el procedimiento para la manipulación de las salidas de los GCM"
- "Estimar la tasa de cambio por periodos de interés (2020s, 2050s, 2080s) de las salidas de los GCM"
keypoints:
- "Python nos ayuda a sistematizar el manejo de las salidas de los GCM."
source: Rmd
---
