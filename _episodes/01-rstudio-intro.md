...
[Descarga e instala la última versión de R aquí](https://cran.r-project.org/bin/windows/base/), 
[descarga e instala RStudio aquí](https://rstudio.com/products/rstudio/download/),
[descarga e instala RTools aquí](https://cran.r-project.org/bin/windows/Rtools/)


## Introducción a RStudio


Bienvenido! A lo largo de esta lección, vamos a enseñarte algunos de los fundamentos del lenguaje R, así como algunas buenas prácticas para organizar el código de proyectos científicos que harán tu vida más fácil.
...
> ¡Esto se aplica también a los usuarios de Linux o Mac!
>
