...
# Instead, please edit 02-data-structures-part1.md in _episodes_rmd/
...
>
> Alternativamente, puedes crear el archivo `data/feline-data.csv` usando un editor de texto (Notepad++),
